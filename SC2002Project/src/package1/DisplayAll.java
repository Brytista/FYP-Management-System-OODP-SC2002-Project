...
/**
 * Class for UI purposes to display requests
 */
public class DisplayAll {

    /**
    *Displays the request history passed as a parameter. If the list is empty, displays a message indicating that there are no requests found.
    *@param requestHistory the list of Request objects to be displayed
    */
    ...
    /**
    *Displays the pending requests passed as a parameter. If the list is empty, displays a message
    *indicating that there are no pending requests found. Otherwise, prompts the user to select an
    *action (approve or reject) for each request and displays the request details and status.
    *@param pendingRequest the list of Request objects to be displayed
    */
