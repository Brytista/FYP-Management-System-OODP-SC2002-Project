...
public void displayRequestDescription(){
    try {
        supervisor = project.getSupervisor();
        if(supervisor.capReached()){
            extraDescription = "The replacement supervisor has reached cap number of student managed, you may not want to accept the request." + " He/She is currently managing "+ supervisor.getStudentsManaged().size() + " students."; 
        }
        else{
