                    ...
                    switch (type) {
                        ...
                        case (2):
                            try {
                                ...
                                System.out.println("An error occurred during supervisor login: " + e.getMessage());
                            }
                            break;
                        case (3):
                            try {
                                ...
                                System.out.println("An error occurred during FYP coordinator login: " + e.getMessage());
                            }
                            break;
                        default:
                    ...
                    while (currentStudent != null && currentStudent.isLoggedIn()) {
                        ...
                        switch (option2) {
                                    ...
                                    case (1):
                                        ...
                                        try {
                                            ...
                                            while(Project.getProjectByID(projectID).getProjectStatus() != ProjectStatus.AVAILABLE){
                                                System.out.println("Invalid input. Please enter a valid projectID. It must be an available project from the list!");
                                                projectID = sc.nextInt();
                                                sc.nextLine();
                                            }
                                        } catch (InputMismatchException e) {
                                        ...
                                        while(FYPCoordinator.getCoordinatorByID(recipientID) == null){
                                            System.out.println("Invalid input. Please enter a valid recipientID. It must be a FYP Coordinator from the list!");
                                            recipientID = sc.nextLine();
                                        }
                            ...
                            case (4):
                                ...
                                System.out.println("You will be logged out now. Please login again with your new password to continue.");
                            ...
                            case (1):
                                ...
                                while (currentSupervisor.makeRequest(recipientFYPCoordinatorID, projectID, replacementID) == 0) {
                                    ...
                                    while(Supervisor.getSupervisorByID(replacementID) == null){
                                        System.out.println("Invalid input. Please enter a valid replacementID. It must be a Supervisor from the list!");
                                        replacementID = sc.nextLine();
                                    }
                                }
                        System.out.println("Request is sent");
                    ...
                    while(currentFYPCoordinator != null && currentFYPCoordinator.isLoggedIn()){
                        ...
                        switch(option3){
                            ...
                            System.out.println("Choose a request type: ");
                                ...
                                while (!currentFYPCoordinator.doesProjectBelongToSupervisor(Project.getProjectByID(projectID))) {
                                    System.out.println("Only select projects that you are supervising!");
                                    System.out.println("Input ID of projects you wanted to change: ");
                                    try {
                                        projectID = sc.nextInt();
                                ...
                                //Iterate until the request is sent
                                while (currentFYPCoordinator.makeRequest(recipientFYPCoordinatorID, projectID, replacementID) == 0) {
                                    System.out.println("Input recipient ID (FYP Coordinator ID): ");
                                    recipientFYPCoordinatorID = sc.nextLine();
                                    while(FYPCoordinator.getCoordinatorByID(recipientFYPCoordinatorID) == null){
                                        System.out.println("Invalid input. Please enter a valid recipientID. It must be a FYP Coordinator from the list!");
                                    ...
                                    replacementID = sc.nextLine();
                                    while(Supervisor.getSupervisorByID(replacementID)==null){
                                        System.out.println("Invalid input. Please enter a valid replacement ID. It must be a Supervisor from the list!");
                                        replacementID = sc.nextLine();
                                    }
                                }
                                System.out.println("Request is sent");
                            ...
                            while (!currentFYPCoordinator.doesProjectBelongToSupervisor(Project.getProjectByID(projectID2))) {
                                System.out.println("Only select projects that you are supervising!");
                                System.out.println("Input ID of projects you wanted to change: ");
                                try {
                                    projectID2 = sc.nextInt();
